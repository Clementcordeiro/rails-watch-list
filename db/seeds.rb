...
list2 = List.create(name: 'Love')
list3 = List.create(name: 'Comedy')
list4 = List.create(name: 'Best movies')

Bookmark.create(movie: movie1, list: list1, comment: "bla super movie")
Bookmark.create(movie: movie2, list: list1, comment: "bla super movie")
Bookmark.create(movie: movie3, list: list2, comment: "bla super movie")